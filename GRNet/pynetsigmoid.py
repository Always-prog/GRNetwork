...
class Network5():
    ...
    def think(self,inputs):
        ...
        return self.N5
    def SaveWeight(self):
        np.save("saves/Weight1",self.W1)
        np.save("saves/Weight2",self.W2)
        np.save("saves/Weight3",self.W3)
        np.save("saves/Weight4",self.W4)
    def LoadWeight(self):
        path = os.getcwd()
        try:
            os.mkdir(path+"/saves")
            ...
            pass
        self.W1 = np.load("saves/Weight1.npy")
        self.W2 = np.load("saves/Weight2.npy")
        self.W3 = np.load("saves/Weight3.npy")
        self.W4 = np.load("saves/Weight4.npy")
